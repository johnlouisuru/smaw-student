...
// if(!$allowed_email){
//     echo "Your E-mail is not verified by the Administrator. Contact Your Teacher for permission. You will be redirected shortly.";
...
$conn = $pdo;
$stmt = $conn->prepare("SELECT * FROM students WHERE google_id = :google_id");
...
if ($user) {
    ...
    $_SESSION['student_id'] = $user_info['id'];
