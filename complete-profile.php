...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($lastname) || empty($firstname) || empty($lrn)) {
        ...
        try {
            ...
            $stmt = $conn->prepare("SELECT id FROM students WHERE lrn = :lrn");
            ...
            if ($stmt->fetch()) {
                ...
                // Insert new student
                $stmt = $conn->prepare("
                    INSERT INTO students (google_id, email, lastname, firstname, mi, lrn, profile_picture)
                    VALUES (:google_id, :email, :lastname, :firstname, :mi, :lrn, :profile_picture)
                ");
...
<body>
            ...
            <div class="col-12 col-lg-8">
                <div class="profile-card">
                    <div class="profile-header">
                        ...
                        <h2 class="mt-3 mb-2">Complete Your Profile</h2>
                        <p class="mb-0">Please provide your student information</p>
                    </div>
                        ...
                        <form method="POST" action="" id="profileForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 mb-3">
                                    <label for="lrn" class="form-label required">LRN (Learner Reference Number)</label>
                                    <input type="text" class="form-control" id="lrn" name="lrn" 
                                           pattern="\d{12}" maxlength="12"
                                           value="<?php echo htmlspecialchars($_POST['lrn'] ?? ''); ?>" required>
    ...
    <script>
        // LRN input validation - only allow numbers
